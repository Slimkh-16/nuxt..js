      ...
      <div class="header-top clearfix">
        <div class="container">
          <div class="header-top__left">
            <ul>
              <li v-for="page in contentPages"  v-if="page.is_header"><nuxt-link :to="{ name: 'Content page' , params : {alias : page.alias}}">{{page.title}}</nuxt-link></li>
            </ul>
          </div>
            ...
            <li v-for="link in menu" :class="{ 'with-menu': link.children }">
              ...
              <ul>
                <li v-for="subLink in link.children" class="with-menu" :class="{ 'with-menu': subLink.children.length }">
                  <nuxt-link :to="{ name: 'Products subCategory', params: { 'subCategory' : subLink.alias, 'alias': link.alias } }" :class="{ 'with-menu-lnk': subLink.children.length }">
                    {{subLink.locale.name}}
                  </nuxt-link>
